...
class PH implements Comparable<PH>{
    ...
    public PH(String maPH, String tenPH, int nsPH, int dtb) {
        this.maPH = maPH;
        this.tenPH = tenPH;
        this.nsPH = nsPH;
        this.dtb = dtb;
    ...
    public String toString() {
        return maPH + " " + tenPH + " " + nsPH + " " + dtb;
    }

    public float getDtb() {
        return dtb;
    }
    public int compareTo(PH other){
        if(this.dtb==other.dtb)return this.maPH.compareTo(other.maPH);
        else return Integer.compare(other.dtb, this.dtb);
    }
}
public class J05061 {
    public static void main(String[] args) {
        ...
        for(int i=0;i<n;i++){
            ...
            dtb = Math.min(10, dtb);
            arr.add(new PH(ma,ten,2021-Integer.parseInt(ns.substring(6)),Math.round(dtb)));
        }
