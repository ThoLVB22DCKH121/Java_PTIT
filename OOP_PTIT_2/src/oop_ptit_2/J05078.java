...
class NhanVien78{
    ...
    public NhanVien78(String maNV, String tenNV, long lcb, long ngaycong, PhongBan a) {
        this.maNV = maNV;
        this.tenNV = tenNV;
        this.a = a;
...
public class J05078 {
    public static void main(String[] args) {
        ...
        int m = sc.nextInt();
        ArrayList<NhanVien78> arr = new ArrayList<>();
        for(int i=0;i<m;i++){
            String ma = sc.next();
            sc.nextLine();
            ...
            arr.add(new NhanVien78(ma,ten,lcb,ngaycong,mp.get(ma.substring(3))));
        }
        String maP = sc.next();
        System.out.println("Bang luong phong "+mp.get(maP).getTenP()+":");
        for(NhanVien78 x:arr){
           if(x.getMaNV().substring(3).equals(maP)) System.out.println(x);
        }
    }
}
/*
