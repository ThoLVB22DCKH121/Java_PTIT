...
class LopHocPhan implements Comparable<LopHocPhan>{
    ...
    public String toString() {
        return maN + " " + thu + " " + kip + " " + tenGV + " " + phonghoc;
    }

    public MonHoc74 getA() {
        return a;
    }
...
public class J07074 {
    public static void main(String[] args)throws FileNotFoundException, IOException {
        ...
        System.out.println("LICH GIANG DAY MON "+mp.get(ma).getTenM()+":");
        for(LopHocPhan x:arr){
            if(x.getA().getMaM().equals(ma))System.out.println(x);
        }
        sc.close();
    }
}
